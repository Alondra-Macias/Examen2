...
TIM0:	
	JNB ESTADO_DESPACHANDO, FIN_TIM0
	ACALL DESPACHA_LITRO
...
EXT1:	 
	...
	JB GETTING_DINERO, FIN_EXT1 
	
	SIG_ESTADO:
	CJNE A, #0DH, COMP_F
	SETB ESTADO_DESPACHANDO
	JMP FIN_EXT1

	COMP_F:
	CJNE A, #0FH, FIN_EXT1
	CLR ESTADO_DESPACHANDO 		; SI ES F DEJA DE DESPACHAR
